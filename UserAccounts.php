<?php 
 ...
 // check connection
    ...
    $queryCR = mysqli_query($connect,"select * from user_tbl"); 
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item text-secondary">User account records</li>                          
                        </ol>
                       ...
                       <div class="table-responsive">
                        ...
                        <div class="modal fade" id="removeModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h5 class="modal-title" id="staticBackdropLabel">Are you sure to deactivate this account?</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    Deactivating this account will permanently removing the user’s account.
                                </div>
